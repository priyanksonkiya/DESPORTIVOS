...
public class Badminton extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(Html.fromHtml("<font color='#ff0000'>Badminton</font>"));
        setContentView(R.layout.activity_sports_layout);


        ImageView mainImage = (ImageView) findViewById(R.id.sportimg);
        mainImage.setImageResource(R.drawable.badminton);
        ...
        text.setMovementMethod(new ScrollingMovementMethod());
            text.setText("1. Format of Play: Best of 3 in the order Singles,Doubles, Singles\n"+
                    ...
                    "3. Teams for every game are to be submitted before the match.\n" +
        ...
        fix.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent fixturesIntent = new Intent(Badminton.this, Fixtures.class);
        ...
        res.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent fixturesIntent = new Intent(Badminton.this, Results.class);
                Intent intent = getIntent();
                int position = intent.getIntExtra("int_value", 0);
                fixturesIntent.putExtra("int_value",position);
                startActivity(fixturesIntent);
        ...
        reg.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent registerIntent = new Intent(Badminton.this, Register.class);
                Intent intent = getIntent();
