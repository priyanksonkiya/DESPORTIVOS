...
public class Volleyball extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(Html.fromHtml("<font color='#ff0000'>Volleyball</font>"));
        setContentView(R.layout.activity_sports_layout);


        ImageView mainImage = (ImageView) findViewById(R.id.sportimg);
        mainImage.setImageResource(R.drawable.volleyball);
        ...
        fix.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent fixturesIntent = new Intent(Volleyball.this, Fixtures.class);
        ...
        res.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent fixturesIntent = new Intent(Volleyball.this, Results.class);
                Intent intent = getIntent();
                int position = intent.getIntExtra("int_value", 0);
                fixturesIntent.putExtra("int_value",position);
                startActivity(fixturesIntent);
