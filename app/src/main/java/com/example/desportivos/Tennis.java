    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fix.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent fixturesIntent = new Intent(Tennis.this, Fixtures.class);
        ...
        res.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent fixturesIntent = new Intent(Tennis.this, Results.class);
                Intent intent = getIntent();
                int position = intent.getIntExtra("int_value", 0);
                fixturesIntent.putExtra("int_value",position);
                startActivity(fixturesIntent);
